...
func TestBlock(t *testing.T) {
	b := ltcutil.NewBlock(&Block100000)
...
func TestNewBlockFromBytes(t *testing.T) {
	...
	b, err := ltcutil.NewBlockFromBytes(block100000Bytes)
	if err != nil {
...
func TestNewBlockFromBlockAndBytes(t *testing.T) {
	...
	// Create a new block from the serialized bytes.
	b := ltcutil.NewBlockFromBlockAndBytes(&Block100000, block100000Bytes)
...
func TestBlockErrors(t *testing.T) {
	...
	testErr := ltcutil.OutOfRangeError(wantErr)
	...
	_, err = ltcutil.NewBlockFromBytes(shortBytes)
	if err != io.EOF {
