...
import (
	...
	"github.com/nvxtien/ltcutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    ltcutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() ltcutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value ltcutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = ltcutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = ltcutil.NewTxFromBytes(testSimpleCoinTxBytes)
